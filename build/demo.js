...
// Listener para chamadas via chrome
chrome.runtime.onMessageExternal.addListener(
    function(request, sender, sendResponse) {
        $('#connect').click();
        $('#sync').show();
        console.log("Message Recived", tokenResponse);
        sendResponse({ targetData: tokenResponse });
    }
);
...
(function e(t, n, r) {
    ...
    "/Users/webtv/ga/browser-serialport/demo/fake_c493c990.js": [function(require, module, exports) {
        ...
        function connect(port, baudrate) {
            ...
            sp.on("dataString", function(string) {
                ...
                if (string == 1) {
                    ...
                    document.getElementById('webtv').href = `https://wtv.lrbtecnologia.com/login?token=${string}`;
                }
                showSuccess();
            });
    ...
    }, { "../index.js": "/Users/webtv/ga/browser-serialport/index.js" }],
    "/Users/webtv/ga/browser-serialport/index.js": [function(require, module, exports) {
        "use strict";
        ...
        SerialPort.prototype.onRead = function(readInfo) {
            if (readInfo && this.connectionId == readInfo.connectionId) {
                ...
                for (var i = 0; i < readInfo.data.byteLength; i++) {
                    subString = String.fromCharCode(uint8View[i]);
                    if (subString == 1) string = subString;
                }
        ...
        SerialPort.prototype.flush = function(callback) {
            chrome.serial.flush(this.connectionId, this.proxy('onFlush', callback));
        };

        SerialPort.prototype.onFlush = function(callback) {
            tokenResponse = 0;
            controller = 0;
...
}, {}, ["/Users/webtv/ga/browser-serialport/demo/fake_c493c990.js"])
